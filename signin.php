...
<body>
        ...
        <br><br><br>
        <div class="container">
        <h3 style="color:red;">SIGN IN:</h3><br>
        <form action="signin_submit.php" method="POST" name = "form">
        ...
        <p><a href="signup.php" style="color:green">Not registered yet? Sign up here!</a></p>
        <p><a href="forgotpassword.php" style="color:red">Forgot Password</a></p>
    </div>
           <br><br><br><br><br>
    <?php  
        require 'footer.php';
